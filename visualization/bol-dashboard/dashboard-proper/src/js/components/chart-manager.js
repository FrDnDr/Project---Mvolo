...
export function updateCharts(filteredRows) {
  ...
  UI_ELEMENTS.chart1Title.textContent = `Total Products Sold as per Unit Sold for ${weekLabel} in Bol`;
  UI_ELEMENTS.chart2Title.textContent = `How Frequent Do Customers Buy with a Discounted Price in Bol on ${weekLabel}`;
